...
!----------------------------------------------------------------------
  ...
  !
  ! Symmetry. Note that it is possible that the bra and ket wave functions
  ! correspond to different point groups
  !
  integer(is)      :: ipgB,ipgK       ! Indices of the point groups
  integer(is)      :: nirrepB,nirrepK ! Numbers of irreps in the point groups
  character(len=3) :: pgroupB,pgroupK ! Point group labels
