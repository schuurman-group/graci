...
!######################################################################
! pattern_index_km1: Given an SOP with nopen open shells, creation and
...
!######################################################################
  function pattern_index_km1(sop,ic,ja,nc,na,nopen,icase) &
       result(pattern)
    ...
    case(i1a) ! Sub-case 1a
       pattern=pattern_index_case1a_km1(sop,ic,ja,nc,na,nopen)
    
    case(i1b) ! Sub-case 1b
       pattern=pattern_index_case1b_km1(sop,ic,ja,nc,na,nopen)
    
    case(i2a) ! Sub-case 2a
       pattern=pattern_index_case2a_km1(sop,ic,ja,nc,na,nopen)
    
    case(i2b) ! Sub-case 2b
       pattern=pattern_index_case2b_km1(sop,ic,ja,nc,na,nopen)
    
    case default ! Unrecognised bitstring encoding
       errmsg='Error in pattern_index_km1: unrecognised bitstring ' &
            //'encoding'
       call error_control
  ...
  end function pattern_index_km1

!######################################################################
! pattern_index_case1a_km1: Given an SOP with nopen open shells and
...
!                           excitation
!######################################################################
  function pattern_index_case1a_km1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
!----------------------------------------------------------------------
  ...
  end function pattern_index_case1a_km1

!######################################################################
! pattern_index_case1b_km1: Given an SOP with nopen open shells and
!                           creation and annihilation operator indices,
...
!                           excitation
!######################################################################
  function pattern_index_case1b_km1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
!----------------------------------------------------------------------
  ...
  end function pattern_index_case1b_km1

!######################################################################
! pattern_index_case2a_km1: Given an SOP with nopen open shells and
!                           creation and annihilation operator indices,
...
!                           excitation
!######################################################################
  function pattern_index_case2a_km1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
! Pattern index
!----------------------------------------------------------------------
    pattern=patmap2a_minus(ip)+shift
    
    return
    
  end function pattern_index_case2a_km1

!######################################################################
! pattern_index_case2b_km1: Given an SOP with nopen open shells and
!                           creation and annihilation operator indices,
...
!                           excitation
!######################################################################
  function pattern_index_case2b_km1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
! Pattern index
!----------------------------------------------------------------------
    pattern=patmap2b_minus(ip)+shift

    return
    
  end function pattern_index_case2b_km1
  
!######################################################################
  
end module pattern_indices_km1
