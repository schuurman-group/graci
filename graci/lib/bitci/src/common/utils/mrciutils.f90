...
!                            external MOs from an array of reference
!                            space configuration bit strings.. That is,
!                            the lists of MOs that are and are not
!                            occupied in at least one reference space
!                            configuration.
!######################################################################
