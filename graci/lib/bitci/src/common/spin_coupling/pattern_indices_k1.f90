...
!######################################################################
! pattern_index_k1: Given an SOP with nopen open shells, creation and
...
!######################################################################
  function pattern_index_k1(sop,ic,ja,nc,na,nopen,icase) &
       result(pattern)
    ...
    case(i1a) ! Sub-case 1a
       pattern=pattern_index_case1a_k1(sop,ic,ja,nc,na,nopen)
    
    case(i1b) ! Sub-case 1b
       pattern=pattern_index_case1b_k1(sop,ic,ja,nc,na,nopen)
    
    case(i2a) ! Sub-case 2a
       pattern=pattern_index_case2a_k1(sop,ic,ja,nc,na,nopen)
    
    case(i2b) ! Sub-case 2b
       pattern=pattern_index_case2b_k1(sop,ic,ja,nc,na,nopen)
    
    case default ! Unrecognised bitstring encoding
       errmsg='Error in pattern_index_k1: unrecognised bitstring ' &
            //'encoding'
       call error_control
  ...
  end function pattern_index_k1

!######################################################################
! pattern_index_case1a_k1: Given an SOP with nopen open shells and
...
!                          excitation
!######################################################################
  function pattern_index_case1a_k1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
! Pattern index
!----------------------------------------------------------------------
    pattern=patternmap1(ip)+shift
    
    return

  end function pattern_index_case1a_k1

!######################################################################
! pattern_index_case1b_k1: Given an SOP with nopen open shells and
!                          creation and annihilation operator indices,
...
!                          excitation
!######################################################################
  function pattern_index_case1b_k1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
!----------------------------------------------------------------------
  ...
  end function pattern_index_case1b_k1

!######################################################################
! pattern_index_case2a_k1: Given an SOP with nopen open shells and
!                          creation and annihilation operator indices,
...
!                          excitation
!######################################################################
  function pattern_index_case2a_k1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
! Pattern index
!----------------------------------------------------------------------
    pattern=patternmap2a(ip)+shift
    
    return
    
  end function pattern_index_case2a_k1

!######################################################################
! pattern_index_case2b_k1: Given an SOP with nopen open shells and
!                          creation and annihilation operator indices,
...
!                          excitation
!######################################################################
  function pattern_index_case2b_k1(sop,ic,ja,nc,na,nopen) &
       result(pattern)
...
! Pattern index
!----------------------------------------------------------------------
    pattern=patternmap2b(ip)+shift

    return
    
  end function pattern_index_case2b_k1
  
!######################################################################
  
end module pattern_indices_k1
