...
!######################################################################
  subroutine remove_duplicates_2I(n2I,cfgM,file2I,nrec2I)
    ...
    ! Everything else
    integer(is)                   :: i,n,ioff,imo,ic,jc,i2h
...
!----------------------------------------------------------------------
    ...
    do irec=1,nrec2I
       ...
       do i=1,nbuf
          ...
          ! Full 2I conf
          confI=create_electron(cfgM%conf2h(:,:,i2h),n_int_I,ic)
          conf=0_ib
          conf(1:n_int_I,:)=confI
...
!----------------------------------------------------------------------
    ...
    do irec=1,nrec1I1E
       ...
       do i=1,nbuf
          ...
          ! Full 1I1E conf
          conf=0_ib
          conf(1:n_int_I,:)=cfgM%conf2h(:,:,i2h)
...
!----------------------------------------------------------------------
! Generate the 1I1E configurations
!----------------------------------------------------------------------
    ! DFT/MRCI energy selection limit
    if (ldftmrci) elim=E0max+desel
