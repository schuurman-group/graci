...
!----------------------------------------------------------------------
    call save_hij_same_conf(iscratch,ibuffer,hbuffer,nrec,nbuf,&
...
!                     couplings
!######################################################################  
  subroutine save_hij_same_conf(iscratch,ibuffer,hbuffer,nrec,nbuf,&
       averageii,confdim,cfg)
...
!######################################################################
  subroutine save_hij_0h_1h(iscratch,ibuffer,hbuffer,nrec,nbuf,&
    ...
    ! Everything else
    integer(is)                :: ibconf1I,ibconf1E,ikconf
