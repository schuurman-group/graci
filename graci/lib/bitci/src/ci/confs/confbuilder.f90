...
!----------------------------------------------------------------------
    ...
    do irec=1,nrec2I
       ...
       do i=1,nbuf
          ...
          irrep=sop_sym_mrci(sop,cfgM(0)%m2c)
    ...
    do irec=1,nrec1I1E
       ...
       ! Read in the next batch of confs
       read(iscratch1I1E) nbuf,cbuf,ibuf
...
!----------------------------------------------------------------------
! Allocate the configuration and offset arrays
!----------------------------------------------------------------------
    print*,''
    print*,'We need to save the a2I and a1I1E arrays to disk!'
    print*,''
