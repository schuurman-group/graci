...
subroutine generate_ras_dets(iras1,iras2,iras3,nras1,mras1,nras2,&
     mras2,nras3,mras3,ndet) bind(c,name="generate_ras_dets")
#else
subroutine generate_ras_dets(iras1,iras2,iras3,nras1,mras1,nras2,&
     mras2,nras3,mras3,ndet)
#endif
...
!----------------------------------------------------------------------
  call make_ras_dets(iras1,iras2,iras3,nras1,mras1,nras2,mras2,nras3,&
       mras3,ndet)
...
!######################################################################
subroutine make_ras_dets(iras1,iras2,iras3,nras1,mras1,nras2,mras2,&
     nras3,mras3,ndet)
...
!----------------------------------------------------------------------
! Allocate the RAS determinant array
!----------------------------------------------------------------------
  allocate(detras(n_int,2,ndet))
...
!----------------------------------------------------------------------
! Write the RAS determinants to disk
!----------------------------------------------------------------------
...
!----------------------------------------------------------------------
! Deallocate the RAS determinant array
!----------------------------------------------------------------------
  deallocate(detras)
