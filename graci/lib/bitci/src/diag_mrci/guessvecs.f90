!**********************************************************************
! Module for the calculation of guess vectors for use in an interative
! diagonalisation calculation
!**********************************************************************
module guessvecs_mrci

contains

!######################################################################
! guess_unit: Generation of guess vectors corresponding to single CSFs
!######################################################################
  subroutine guess_unit(guessscr,nguess,dim,subdim,hdiag)
...
!----------------------------------------------------------------------
  ...
  end subroutine guess_unit
  
!######################################################################
! guess_subspace: Generation of guess vectors via subspace
!                 diagonalisation
!######################################################################
  subroutine guess_subspace(guessscr,nguess,cfg,dim,subdim,hdiag,&
       averageii,confdim)
