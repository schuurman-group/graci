"""
Module for computing HF or PKS-DFT orbitals and energies
...
#        self.solvent        = None
        ...
        # class variables
        self.valid_grids  = ['nwchem_prune'] # sg1_prune supports up to Z=19.
...
# Required functions #######################################################
    ...
    def run(self, mol, guess):
        ...
        # the charge and multiplity of the (p)scf sections
